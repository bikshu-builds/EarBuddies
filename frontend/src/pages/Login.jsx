...
const Login = () => {
  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      ...
      >
        ...
        <div className="relative">
          ...
          >
            ...
            <p className="text-gray-600 text-sm">Sign in to continue your music journey</p>
          </motion.div>
